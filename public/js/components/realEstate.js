    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Listings2.default, { globalState: this.state, listingsData: this.state.filteredData, change: this.change, changeView: this.changeView })
        )
      );
    }
  }]);
...
var listingsData = [{
    ...
    price: 500000,
    floorSpace: 2200,
    extras: ['tennis court', 'finished_basement'],
    homeType: 'Condo',
    ...
    price: 700000,
    floorSpace: 2300,
    extras: ['covered patio', 'finished_basement'],
    homeType: 'Rancher',
